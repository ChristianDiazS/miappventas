...
export function DecoracionBano() {
  ...
  // Array con todas las imágenes de dispensadores disponibles
  const dispensadorImages = [
    'img-dispensador1', 'img-dispensador2', 'img-dispensador3', 
    'img-dispensador4', 'img-dispensador5', 'img-dispensador6',
    'img-dispensador7', 'img-dispensador8', 'img-dispensador9',
    'img-dispensador10', 'img-dispensador11'
  ];

  // Imágenes de referencia de baños decorados
  const referenceProducts = [
    {
      image: 'https://res.cloudinary.com/dy73lxudf/image/upload/c_limit,f_auto,q_auto,w_400/decoracion-para-bano/img-dispensador1.jpg',
      title: 'Dispensador 1',
      description: 'Diseño moderno y elegante'
    },
    {
      image: 'https://res.cloudinary.com/dy73lxudf/image/upload/c_limit,f_auto,q_auto,w_400/decoracion-para-bano/img-dispensador2.jpg',
      title: 'Dispensador 2',
      description: 'Colores vibrantes'
    },
    {
      image: 'https://res.cloudinary.com/dy73lxudf/image/upload/c_limit,f_auto,q_auto,w_400/decoracion-para-bano/img-dispensador3.jpg',
      title: 'Set Completo',
      description: 'Combo perfecto'
    },
    {
      image: 'https://res.cloudinary.com/dy73lxudf/image/upload/c_limit,f_auto,q_auto,w_400/decoracion-para-bano/img-dispensador4.jpg',
      title: 'Diseño Premium',
      description: 'Lujo y confort'
    },
    {
      image: 'https://res.cloudinary.com/dy73lxudf/image/upload/c_limit,f_auto,q_auto,w_400/decoracion-para-bano/img-dispensador5.jpg',
      title: 'Estilo Minimalista',
      description: 'Simplicidad pura'
    }
  ];
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      // Filtrar solo productos de Decoración para el Baño
      const banoProducts = (data.data || []).filter(p => 
        p.category === 'Decoración para el Baño'
      );
      setProducts(banoProducts);
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 bg-gradient-to-r from-blue-500 to-teal-500 rounded-2xl p-8 md:p-12 text-white shadow-2xl">
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold mb-3">🛁 Transforma tu Baño en un Oasis</h1>
            <p className="text-blue-100 text-base md:text-lg mb-2">
              Descubre nuestra exclusiva colección de accesorios y decoración para baño.
            </p>
            <p className="text-blue-100 text-sm md:text-base">
              Dispensadores de jabón, sets de baño, porta cepillos y más. Elige los productos que reflejen tu estilo personal.
            </p>
          </div>
          ...
          <Button
            ...
            className="w-full sm:w-auto bg-white text-blue-600 hover:bg-gray-100 font-bold px-8 py-3 rounded-lg border-4 border-white"
          >
        ...
        <div id="productos-section" className="mb-12">
          ...
          <p className="text-gray-600 text-lg">
            Selecciona los accesorios que te gusten y personaliza tu baño
          </p>
        </div>
            ...
            {products.map(product => (
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  {/* Precio */}
                  <div className="mb-3 py-2 bg-blue-50 rounded px-2 text-center border border-blue-200">
